 ...
 */
class Projeto extends \App\Models\Entity\Projeto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Models\\Entity\\Projeto' . "\0" . 'id', '' . "\0" . 'App\\Models\\Entity\\Projeto' . "\0" . 'descricao'];
        }
